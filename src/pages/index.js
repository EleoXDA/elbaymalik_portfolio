        ...
        <Layout className="!pt-0 md:!pt-16 sm:!pt-16">
          <div className="flex w-full items-start justify-between md:flex-col">
            ...
            <div className="flex w-1/2 flex-col items-center self-center lg:w-full lg:text-center">
              ...
              As a skilled full-stack developer, I am dedicated to turning ideas into innovative web or mobile applications. Explore my latest projects, showcasing my expertise in fullstack web development.
              </p>
